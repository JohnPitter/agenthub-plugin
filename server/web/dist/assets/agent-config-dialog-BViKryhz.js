import{u as _,r,e as d,j as e,a8 as p,X as q,a9 as y,g as c,o as I,B,aa as W}from"./index-kEhsIY3n.js";import{a as G,g as T}from"./models-rD-XCoDY.js";import{C as H}from"./chevron-up-DGMMWpe_.js";const J={architect:`# Soul: Architect
...
- You complete tasks thoroughly and report results clearly`},Q=["default","acceptEdits","bypassPermissions"],K=["junior","pleno","senior","especialista","arquiteto"],X=["Read","Glob","Grep","Bash","Write","Edit","Task","WebSearch","WebFetch"];function ae({agent:s,onSave:C,onClose:u}){const{t:n}=_(),[g,E]=r.useState([]);r.useEffect(()=>{d("/plans/models").then(t=>{var a;(a=t.models)!=null&&a.length&&E(t.models)}).catch(()=>{})},[]);const P=typeof s.allowedTools=="string"?JSON.parse(s.allowedTools):s.allowedTools??[],[m,z]=r.useState(s.model),[l,k]=r.useState(s.maxThinkingTokens??0),[w,L]=r.useState(P),[j,M]=r.useState(s.systemPrompt??""),[x,O]=r.useState(s.permissionMode??"default"),[N,D]=r.useState(s.level??"senior"),[i,b]=r.useState(s.avatar??""),[h,V]=r.useState(!1),[S,Y]=r.useState(s.soul??""),[A,R]=r.useState([]),[f,v]=r.useState(new Set);r.useEffect(()=>{d("/skills").then(t=>R(t.skills)).catch(()=>{}),d(`/agents/${s.id}/skills`).then(t=>{v(new Set(t.skills.map(a=>a.id)))}).catch(()=>{})},[s.id]);const $=async t=>{try{f.has(t)?(await d(`/agents/${s.id}/skills/${t}`,{method:"DELETE"}),v(a=>{const o=new Set(a);return o.delete(t),o})):(await d(`/agents/${s.id}/skills`,{method:"POST",body:JSON.stringify({skillId:t})}),v(a=>new Set(a).add(t)))}catch{}},F=t=>{L(a=>a.includes(t)?a.filter(o=>o!==t):[...a,t])},U=async()=>{await C(s.id,{model:m,level:N,avatar:i||void 0,maxThinkingTokens:l>0?l:null,allowedTools:w,systemPrompt:j.trim()||void 0,permissionMode:x,soul:S.trim()||null}),u()};return e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black/40",onClick:u,children:e.jsxs("div",{className:"w-full max-w-xl max-h-[85vh] overflow-y-auto rounded-lg bg-neutral-bg1 p-6 shadow-16 animate-fade-up",onClick:t=>t.stopPropagation(),children:[e.jsxs("div",{className:"flex items-center justify-between mb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[p(i)?e.jsx("img",{src:p(i,40),alt:s.name,className:"h-10 w-10 rounded-md bg-neutral-bg2"}):e.jsx("div",{className:"flex h-10 w-10 items-center justify-center rounded-md text-[14px] font-semibold text-white",style:{backgroundColor:s.color??"#6366F1"},children:s.name.charAt(0)}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-[18px] font-semibold text-neutral-fg1",children:s.name}),e.jsx("p",{className:"text-[12px] text-neutral-fg3",children:s.role})]})]}),e.jsx("button",{onClick:u,className:"rounded-md p-2 text-neutral-fg3 transition-colors hover:bg-neutral-bg-hover hover:text-neutral-fg1",children:e.jsx(q,{className:"h-5 w-5"})})]}),e.jsxs("div",{className:"flex flex-col gap-5",children:[e.jsxs("div",{children:[e.jsx("label",{className:"mb-1.5 block text-[12px] font-semibold uppercase tracking-wider text-neutral-fg2",children:n("settings.avatar")}),e.jsx("div",{className:"grid grid-cols-8 gap-2",children:y[0].avatars.map(t=>{const a=i===t.value;return e.jsxs("button",{type:"button",onClick:()=>b(a?"":t.value),className:c("flex flex-col items-center gap-1 rounded-lg p-1.5 transition-all",a?"bg-brand-light ring-2 ring-brand":"hover:bg-neutral-bg-hover"),title:t.label,children:[e.jsx("img",{src:p(t.value,48),alt:t.label,className:"h-10 w-10 rounded-md",loading:"lazy"}),e.jsx("span",{className:"text-[9px] font-medium text-neutral-fg3 truncate w-full text-center",children:t.label})]},t.value)})}),e.jsxs("button",{type:"button",onClick:()=>V(!h),className:"mt-2 flex items-center gap-1.5 text-[11px] font-medium text-brand hover:text-brand-hover transition-colors",children:[h?n("settings.lessAvatars"):`${n("settings.moreAvatars")} (${y.reduce((t,a)=>t+a.avatars.length,0)})`,h?e.jsx(H,{className:"h-3.5 w-3.5"}):e.jsx(I,{className:"h-3.5 w-3.5"})]}),h&&e.jsx("div",{className:"mt-2 space-y-4 rounded-lg border border-stroke bg-neutral-bg2 p-4 animate-fade-up",children:y.slice(1).map(t=>e.jsxs("div",{children:[e.jsx("p",{className:"mb-2 text-[11px] font-semibold uppercase tracking-wider text-neutral-fg3",children:t.category}),e.jsx("div",{className:"grid grid-cols-8 gap-2",children:t.avatars.map(a=>{const o=i===a.value;return e.jsxs("button",{type:"button",onClick:()=>b(o?"":a.value),className:c("flex flex-col items-center gap-1 rounded-lg p-1.5 transition-all",o?"bg-brand-light ring-2 ring-brand":"hover:bg-neutral-bg-hover"),title:a.label,children:[e.jsx("img",{src:p(a.value,48),alt:a.label,className:"h-10 w-10 rounded-md",loading:"lazy"}),e.jsx("span",{className:"text-[9px] font-medium text-neutral-fg3 truncate w-full text-center",children:a.label})]},a.value)})})]},t.category))}),i&&e.jsx("button",{type:"button",onClick:()=>b(""),className:"mt-2 text-[11px] font-medium text-danger hover:underline",children:n("settings.removeAvatar")})]}),e.jsxs("div",{children:[e.jsx("label",{className:"mb-1.5 block text-[12px] font-semibold uppercase tracking-wider text-neutral-fg2",children:n("agents.model")}),e.jsx("select",{value:m,onChange:t=>z(t.target.value),className:"w-full rounded-md border border-stroke bg-neutral-bg2 px-4 py-3 text-[14px] text-neutral-fg1 outline-none transition-all focus:border-brand focus:ring-2 focus:ring-brand-light",children:g.length>0?Object.entries(g.reduce((t,a)=>{const o=G(a.id);return t[o]||(t[o]=[]),t[o].push(a),t},{})).map(([t,a])=>e.jsx("optgroup",{label:t,children:a.map(o=>e.jsx("option",{value:o.id,children:T(o.id)},o.id))},t)):e.jsx("option",{value:m,children:T(m)})}),g.length===0&&e.jsx("p",{className:"mt-1.5 text-[11px] text-neutral-fg3",children:"Modelos disponíveis via Claude Code CLI"})]}),e.jsxs("div",{children:[e.jsx("label",{className:"mb-1.5 block text-[12px] font-semibold uppercase tracking-wider text-neutral-fg2",children:n("agents.permissions")}),e.jsx("select",{value:x,onChange:t=>O(t.target.value),className:"w-full rounded-md border border-stroke bg-neutral-bg2 px-4 py-3 text-[14px] text-neutral-fg1 outline-none transition-all focus:border-brand focus:ring-2 focus:ring-brand-light",children:Q.map(t=>e.jsx("option",{value:t,children:n(`permissions.${t}`)},t))}),e.jsx("p",{className:"mt-1.5 text-[11px] text-neutral-fg3",children:n(`permissions.${x}Desc`)})]}),e.jsxs("div",{children:[e.jsx("label",{className:"mb-1.5 block text-[12px] font-semibold uppercase tracking-wider text-neutral-fg2",children:n("agents.level")}),e.jsx("select",{value:N,onChange:t=>D(t.target.value),className:"w-full rounded-md border border-stroke bg-neutral-bg2 px-4 py-3 text-[14px] text-neutral-fg1 outline-none transition-all focus:border-brand focus:ring-2 focus:ring-brand-light",children:K.map(t=>e.jsx("option",{value:t,children:n(`levels.${t}`)},t))})]}),e.jsxs("div",{className:"rounded-lg border border-stroke bg-neutral-bg2 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between mb-1",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(B,{className:"h-4 w-4 text-purple"}),e.jsx("label",{className:"text-[12px] font-semibold uppercase tracking-wider text-neutral-fg2",children:"Extended Thinking"})]}),e.jsx("button",{type:"button",onClick:()=>k(l>0?0:32e3),className:c("relative h-5 w-9 rounded-full transition-all duration-200",l>0?"bg-gradient-to-r from-brand to-purple shadow-brand":"bg-stroke"),children:e.jsx("span",{className:c("absolute top-0.5 left-0.5 h-4 w-4 rounded-full bg-white shadow-sm transition-all duration-200",l>0&&"left-[18px]")})})]}),e.jsx("p",{className:"text-[11px] text-neutral-fg3 mb-3",children:n("agents.thinkingTokens")}),l>0&&e.jsxs("div",{className:"pt-3 border-t border-stroke",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsx("span",{className:"text-[11px] text-neutral-fg3",children:"Budget de tokens"}),e.jsxs("span",{className:"text-[12px] font-semibold text-purple tabular-nums",children:[(l/1e3).toFixed(0),"k"]})]}),e.jsx("div",{className:"grid grid-cols-4 gap-2",children:[32e3,64e3,128e3,256e3].map(t=>e.jsxs("button",{type:"button",onClick:()=>k(t),className:c("rounded-lg py-2 text-[12px] font-semibold transition-all",l===t?"bg-purple text-white shadow-brand":"bg-neutral-bg3 text-neutral-fg2 hover:bg-neutral-bg-hover hover:text-neutral-fg1"),children:[t/1e3,"k"]},t))})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"mb-2 block text-[12px] font-semibold uppercase tracking-wider text-neutral-fg2",children:n("agents.tools")}),e.jsx("div",{className:"flex flex-wrap gap-2",children:X.map(t=>{const a=w.includes(t);return e.jsx("button",{onClick:()=>F(t),className:`rounded-md px-3 py-1.5 text-[12px] font-medium transition-all ${a?"bg-brand text-white":"bg-neutral-bg2 text-neutral-fg3 hover:bg-stroke2 hover:text-neutral-fg2"}`,children:t},t)})})]}),e.jsxs("div",{children:[e.jsxs("label",{className:"mb-2 block text-[12px] font-semibold uppercase tracking-wider text-neutral-fg2",children:[n("skills.title")," (",f.size,")"]}),A.filter(t=>t.isActive).length>0?e.jsx("div",{className:"flex flex-wrap gap-2",children:A.filter(t=>t.isActive).map(t=>{const a=f.has(t.id);return e.jsx("button",{onClick:()=>$(t.id),className:`rounded-md px-3 py-1.5 text-[12px] font-medium transition-all ${a?"bg-brand text-white":"bg-neutral-bg2 text-neutral-fg3 hover:bg-stroke2 hover:text-neutral-fg2"}`,title:t.description??void 0,children:t.name},t.id)})}):e.jsx("p",{className:"text-[12px] text-neutral-fg3 italic",children:n("skills.noSkillsAvailable")})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center justify-between mb-1.5",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(W,{className:"h-4 w-4 text-purple"}),e.jsx("label",{className:"text-[12px] font-semibold uppercase tracking-wider text-neutral-fg2",children:n("agents.soul")})]}),e.jsx("button",{type:"button",onClick:()=>Y(J[s.role]??""),className:"text-[11px] font-medium text-brand hover:text-brand-hover transition-colors",children:"Usar template"})]}),e.jsx("p",{className:"mb-2 text-[11px] text-neutral-fg3",children:"Define a personalidade, valores e estilo do agente. Injetado antes do prompt base."}),e.jsx("textarea",{value:S,onChange:t=>Y(t.target.value),placeholder:`# Soul: Agent Name
